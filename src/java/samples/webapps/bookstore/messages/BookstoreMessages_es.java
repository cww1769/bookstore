...
public class BookstoreMessages_es extends ListResourceBundle {
  ...
  {"ServerError", "Su petici" + "\u00f3" + "n no pudo completarse. El servidor devolvi" + "\u00f3" + " el error siguiente: "},
  ...
  {"Talk", " describe como componentes de software de web pueden transformar la manera en que desrrollamos aplicaciones para el web. Este libro es obligatorio para cualquier programador de respeto!"},
  ...
  {"Purchase", "Para poder comprar los art" + "\u00ed" + "culos en su carro de compras, facilite la informaci" + "\u00f3" + "n siguiente:"},
  {"Name", "Nombre:"},
  {"CCNumber", "N" + "\u00fa" + "mero de Tarjeta de Cr" + "\u00e9" + "dito:"},
  {"Submit", "Entregar la Informaci" + "\u00f3" + "n"},
  {"Catalog", "Volver al Cat" + "\u00e1" + "logo"},
  {"ThankYou", "Gracias por su compra "},
  {"OrderError", "Su compra no pudo completarse."}
  };
}
